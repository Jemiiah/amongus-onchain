...
/**
 * @title Deploy
 * @notice Deployment script for Among Us On-Chain contracts on Monad Testnet
 * @dev Run with: forge script script/Deploy.s.sol --rpc-url $MONAD_RPC_URL --broadcast
 */
