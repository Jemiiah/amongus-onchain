...
/**
 * Service for interacting with Among Us On-Chain smart contracts on Monad
 */
export class ContractService {
  ...
  async getWagerAmount(): Promise<bigint> {
    if (!this.enabled) return BigInt(10n * 10n ** 18n); // Default 10 tokens
